...
function buscarNoticias() {
    ...
    noticias.forEach(noticia => {
      const titulo = noticia.getAttribute('data-title').toLowerCase();
      const conteudo = noticia.getAttribute('data-content').toLowerCase();
    ...
    const noticias = [
      {
        ...
        autor: "Alessandro Fernandes Antunes"
      },
      {
        id: "2",
      ...
      },
      {
        ...
        imagem: "assets/img/noticia5.png",
        autor: "Alessandro Fernandes Antunes"
      },
      {
        id: "6",
